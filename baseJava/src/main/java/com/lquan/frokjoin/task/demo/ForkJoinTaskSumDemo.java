...
public class ForkJoinTaskSumDemo {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        ForkJoinTask<Integer> result = pool.submit(new ForkJoinTaskSumDemo().new SumTask(arr, 0, arr.length));
